...
console.log(JSON.stringify({ user: { id: randomUUID(), name: 'Demo User', email: 'demo@example.com', passwordHash: demoPassword }, note: 'Use npm run db:migrate antes de conectar o seed ao banco.' }, null, 2));
